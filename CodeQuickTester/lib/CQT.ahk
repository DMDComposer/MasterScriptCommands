	...
	__New(Settings)
	{
		...
		[
			["&File", [
				...
				[],
				["Comment Lines`tCtrl+J", Buttons.Comment.Bind(Buttons)],
				["Uncomment Lines`tCtrl+Shift+J", Buttons.Uncomment.Bind(Buttons)],
				[],
		...
		; Add run button
		Gui, Add, Button, hWndhRunButton, &Add Command
