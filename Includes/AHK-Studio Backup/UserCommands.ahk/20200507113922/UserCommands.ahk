...
else if MasterScriptCommands = down%A_Space% ; Downloads
{
	...
	gui_destroy()
	;~ Get_Dropbox_Folder()
	RegRead, Var,HKEY_CLASSES_ROOT,CLSID\{E31EA727-12ED-4702-820C-4B6445F28E1A}\Instance\InitPropertyBag,TargetFolderPath
	Run, Var
	;~ Run, D:\Users\%A_Username%\Dropbox\
}
...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	gui_destroy()
	Focus_Send({Window:"Sibelius ahk_class Qt5QWindowIcon",Keys:"^t{Sleep 50}a2{Escape}{Down}{Up}^t",Title:"a2 Players",Background:"#6D4478",TitleMatchMode:"2",Icon:"Sibelius"})
}