...
else if(MasterScriptCommands = "private "){ ;~ Name of Command
	gui_destroy()
...
else if MasterScriptCommands = tor.%A_Space% ; Search torrent networks
{
	...
	gui_search("C:\Program Files (x86)\Google\Chrome\Application\chrome.exe -incognito https://rutracker.org/forum/tracker.php?nm=REPLACEME")
}
/*
