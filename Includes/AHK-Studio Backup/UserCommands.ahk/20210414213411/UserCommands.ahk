...
if (MasterScriptCommands = "g. " || MasterScriptCommands = "google"){ ;~ Search Google
	...
	Notify().AddWindow("" ;~ Remove "" if want to use a variable, NO percents!
		,{Title:"Searching AHK for:" 
		,Font:"Sans Serif"
		,TitleFont:"Sans Serif"
		,Icon:"C:\Program Files\AutoHotkey\AutoHotkey.exe, 1" ;~  Can be either an Integer to pull an icon from Shell32.dll or a full path to an EXE or full path to a dll.  You can add a comma and an integer to select an icon from within that file eg. {Icon:"C:\Windows\HelpPane.exe,2"}
...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	Run, "C:\AHK Studio\AHK-Studio.ahk"
}
