...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	If WinActive("ahk_exe TotalMixFX.exe"){
		Notify().AddWindow("Error converting Rich Text to HTML",{Animate:"Center",ShowDelay:1000,Icon:300,IconSize:50,Title:"Error",TitleSize:14,Size:12,Time:6000,Background:0x0000FF})
		SendInput, {F4}
	}
	Return
}
