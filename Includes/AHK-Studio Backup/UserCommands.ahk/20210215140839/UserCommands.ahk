...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	gui_destroy()
	ydl = "C:\AHK Scripts\Tools\Youtube Downloader\youtube-dl.exe" 
	cmd = --extract-audio --audio-format mp3 
	vid = https://www.youtube.com/watch?v=St0dlI8SadU 
	dir:= "-o" "D:\Users\Dillon\Downloads\Youtube Downloader\"Chr(34)"(title)s."Chr(34)"(ext)s"
	m(ydl cmd vid dir)
