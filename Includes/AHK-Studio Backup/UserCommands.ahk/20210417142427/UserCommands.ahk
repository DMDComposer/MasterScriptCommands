...
if (MasterScriptCommands = "ahk "){ ;~ Search for AHK Related Info
	...
	gui_Change_Title("Autohotkey Google Search","#00FF00")
...
else if(MasterScriptCommands = "tor Skillshare"){ ;~ Name of Command
	gui_destroy()
	gui_search_title:= "Type in the Name of the Skillshare Class"
	gui_Change_Title("Skillshare Class Search","c00FF84")
...
else if(MasterScriptCommands = "force rel"){ ;~ Name of Command
	gui_destroy()
	Gosub, RunReload
}
...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
...
else if(MasterScriptCommands = "remove line breaks" || MasterScriptCommands = "remove returns"){ ;~ Name of Command
	gui_destroy()
...
else if(MasterScriptCommands = "windows snip" || MasterScriptCommands = "snip"){ ;~ Name of Command
	gui_destroy()
	Run "C:\AHK Scripts\Tools\Window Snipping\WindowSnipping.ahk"
}
else if(MasterScriptCommands = "teamv"){ ;~ Name of Command
	gui_destroy()
	Run, "C:\Program Files (x86)\TeamViewer\TeamViewer.exe"
}
else if(MasterScriptCommands = "kill teamv"){ ;~ Name of Command
	gui_destroy()
	Process, Close, TeamViewer.exe
}
else if(MasterScriptCommands = "msi util"){ ;~ Name of Command
	gui_destroy()
	Run, "D:\Users\Dillon\Downloads\MSI Utility v2\MSI_util_v2.exe"
}
...
else if(MasterScriptCommands = "kill ahk"){ ;~ Name of Command
	gui_destroy()
	...
	RegRead, Location,HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\Vienna Ensemble Pro_is1,DisplayIcon ;~ Getting VEPRO Drive Location for Icon
	MouseGetPos,xx,yy ;~ Getting Original Mouse Coordinates to Restore
	...
	Notify().AddWindow("Purge Kontakt"
	,{Title:VEP
	,Font:"Madness Hyperactive"
	,TitleFont:"Madness Hyperactive"
	,Icon:Location
	...
	,OffsetX:-15
	,OffsetY:10
	,Area:"Vienna Ensemble Pro ahk_class Qt5QWindowIcon"
	,Bits:"zzzzzzzzlzzwTzk0Tw07z01zlwTkT1w7kT1w7wT7z01zk0Tw07zwTzz7zzzzzzzzzzy"
	,Ones:280
	,Zeros:120
	,Threshold:132
	,W:20
...
else if(MasterScriptCommands = "reg loc"){ ;~ Name of Command
	gui_destroy()
	Run, "C:\AHK Scripts\_Master Script\Run\Shortcuts\Reg Software Locations - Shortcut.lnk"
}
else if(MasterScriptCommands = "sum of clip"){ ;~ Name of Command
	gui_destroy()
...
else if(MasterScriptCommands = "Studio"){ ;~ Name of Command
	gui_destroy()
	;~ Run, "C:\AHK Scripts\_Master Script\Run\Shortcuts\AHK-Studio - Shortcut.lnk"
	Run "C:\Program Files\AutoHotkey\AutoHotkeyU64_UIA.exe" "C:\AHK Studio\AHK-Studio.ahk"
}
else if(MasterScriptCommands = "n. color"){ ;~ Name of Command
	gui_destroy()
