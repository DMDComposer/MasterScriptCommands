...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	vid:= "%Clipboard%"Chr(32)
	dir:= "-o " """D:\Users\Dillon\Downloads\Youtube Downloader\"Chr(37)"(title)s."Chr(37)"(ext)s"""
	y2mp3:= ydl cmd vid dir	
	Run, %y2mp3%
	Notify().AddWindow(y2mp3,{Animate:"Center",ShowDelay:1000,Icon:300,IconSize:50,Title:"",TitleSize:14,Size:12,Time:6000,Background:0x0000FF})
	/*
