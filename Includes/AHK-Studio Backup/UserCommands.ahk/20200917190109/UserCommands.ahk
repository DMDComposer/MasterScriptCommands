...
else if(MasterScriptCommands = "icon search"){ ;~ Search for Icons
	gui_destroy()
	gui_search("https://www.pngegg.com/en/search?q=REPLACME")
...
else if (MasterScriptCommands = "jxl"){ ; Google Drive JXL
	gui_destroy()
	;~ RegRead, Var,HKEY_CLASSES_ROOT,CLSID\{E31EA727-12ED-4702-820C-4B6445F28E1A}\Instance\InitPropertyBag,TargetFolderPath ;~ Getting GDrive Location
	;~ Run, %Var%
...
else if(MasterScriptCommands = "comp"){ ;~ Open Compositions Folder
	gui_destroy()
...
else if(MasterScriptCommands = "166"){ ;~ Open 1-66 Pipeline in Notion
	gui_destroy()
...
else if(MasterScriptCommands = "jxl deliver"){ ;~ Email Template for Deliverables
	gui_destroy()
	Run, "C:\AHK Scripts\Tools\Email Templates\JXL Deliverables Template v1.00.ahk"
}