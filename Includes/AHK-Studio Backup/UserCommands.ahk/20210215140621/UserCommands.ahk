...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	gui_destroy()
	y2mp3 = """C:\AHK Scripts\Tools\Youtube Downloader\youtube-dl.exe""" --extract-audio --audio-format mp3 https://www.youtube.com/watch?v=St0dlI8SadU -o """D:\Users\Dillon\Downloads\Youtube Downloader\Chr(34)(title)s.Chr(34)(ext)s"
	m(y2mp3)
	;~ RunWait %comspec% %y2mp3%
	/*
...
*/
	...
	*/
	...
	gui_destroy()
	Run, "D:\Users\Dillon\Dropbox\Compositions\Dorico"
}
