...
else if(MasterScriptCommands = "teamviewer"){ ;~ Name of Command
	gui_destroy()
	Run, "C:\Program Files (x86)\TeamViewer\TeamViewer.exe"
}
else if(MasterScriptCommands = "kill teamviewer"){ ;~ Name of Command
	gui_destroy()
...
else if(MasterScriptCommands = "notion home"){ ;~ Notion Home
	gui_destroy()
