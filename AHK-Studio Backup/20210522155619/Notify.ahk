...
Count      := 0
Notify     := Notify(20) ;~ Changing the Y Axis

;~ Defaults but not working atm
/*
	,Font       := "Sans Serif"
	,TitleFont  := "Sans Serif"
	,Icon       := "C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1"
	,Animate    := "Right, Slide"
	,ShowDelay  := 100
	,IconSize   := 64
	,TitleSize  := 14
	...
	,TitleColor := "0xFF0000"
*/
;~ Global Font, TitleFont, Icon, Animate, ShowDelay, IconSize, TitleSize, Size, Radius, Time, Background, Color, TitleColor
...
Class NotifyClass{
	...
	AddWindow(Text,Info:=""){
		(Info?Info:Info:=[])
		for a,b in {{Title:"", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"}}
			if(Info[a]="")
				Info[a]:=b
