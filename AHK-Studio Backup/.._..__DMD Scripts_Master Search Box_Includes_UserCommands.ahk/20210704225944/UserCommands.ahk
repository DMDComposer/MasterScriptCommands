...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	gui_destroy()
	;~ Notify().AddWindow("Empty RecycleBin", {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon: A_SystemDirectory "\imageres.dll, 54", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x0489D8", TitleColor:"0x0489D8"})
	Notify().AddWindow("", {Title:"", Icon: "C:\Windows\system32\imageres.dll,50"})
	FileRecycleEmpty
}
