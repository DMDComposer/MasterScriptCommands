vIni_Path  := "C:\AHK Scripts\_Master Script\Run\Master Search Box\Includes\Directory Paths.ini"
oDir_Paths := DMD_Ini2Obj(vIni_Path)
oDir_Paths := oDir_Paths.Directory_Paths
...
;;; LAUNCH DIRECTORIES ;;;
;--------------------------------------------------------------------------------
else if(oDir_Paths.HasKey(MasterScriptCommands)){ ;~ Testing Directory Objects
	gui_destroy()
