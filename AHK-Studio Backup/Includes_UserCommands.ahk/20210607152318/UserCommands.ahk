...
;--------------------------------------------------------------------------------
...
else if(MasterScriptCommands = "add dir"){ ;~ Add Icon Path to ini File
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	InputBox, vNew_Key, % "New Icon Name", % "New Icon Name: ~Add new Key to ini file"
	if ErrorLevel
		Return
	InputBox, vNew_Value, % "New Path for Icon",  % "New Icon Path: ~Add new Value to ini file"
	if ErrorLevel
		Return
	IniWrite, % vNew_Value, % vIni_Path, Icon_Paths, % "icons." vNew_Key ;~ Write to Icons Paths
}
else if(MasterScriptCommands = "add icon"){ ;~ Add Directory Path to ini File
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	InputBox, vNew_Key, % "New Icon Name", % "New Icon Name: ~Add new Key to ini file"
	if ErrorLevel
	...
	if ErrorLevel
		Return
	IniWrite, vNew_Value, % vIni_Path, Directory_Paths, % vNew_Key ;~ Write to Directories
}
