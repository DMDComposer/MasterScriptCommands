...
else if(MasterScriptCommands = "AHK Tools "){ ;~ AHK Scripts Folder
	gui_destroy()
...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(ErrorLevel)
		return
	Gui,Show
	WB.Document.GetElementByID("shorten_url").Value:=Format("{:L}",My_Text)
	WB.Document.GetElementByID("shorten_btn").Click()
	Sleep, 1500
	Proper:=WB.Document.GetElementByID("shortened_btn").Click()
	Clipboard:=Proper
	m(Clipboard)
	Gui,Destroy
}