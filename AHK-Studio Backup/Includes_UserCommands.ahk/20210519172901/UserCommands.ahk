...
else if(MasterScriptCommands = "Pictures"){ ;~ Pictures
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	gui_destroy()
	DMD_RunShortcut("C:\AHK Scripts\Tools\Title Caplization Check\Title Caplization Check.ahk")
}
	...
	gui_destroy()
	Notify().AddWindow("Sketch Template"
		,{Title:"Kontakt"
		,Font:"Madness Hyperactive"
		,TitleFont:"Madness Hyperactive"
		,Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico"
		,Animate:"Right,Slide"
		;~ ,Flash:150
		;~ ,FlashColor:"0x00FF00"
		,ShowDelay:100	
		...
		,Background:"0xFFFFFF"
		,Color:"0x282A2E"
		,TitleColor:"0xFF0000"}) ;~ Remove "" if want to use a variable, NO percents!
...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	gui_destroy()
	Notify().AddWindow("Force Quitting VEPRO"
		,{Title:"Kill VEPRO"
		,Font:"Sans Serif"
		,TitleFont:"Sans Serif"
		,Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Vienna Ensemble Pro.ico"
		,Animate:"Right,Slide"
		;~ ,Flash:150
		;~ ,FlashColor:"0x00FF00"
		,ShowDelay:100
	...
	*/
...
else if(MasterScriptCommands = "wintitle" || MasterScriptCommands = "window title"){ ;~ Get WinTitle of Current Window
	gui_destroy()
	WinGetTitle, T, A
	Clipboard:= T
	Notify().AddWindow(T, {Title:"Title of Window", Font:"Madness Hyperactive", TitleFont:"Madness Hyperactive", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:6000, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
}
	...
	Notify().AddWindow(Clipboard
		,{Title:"Clipboard has been changed"
		,Font:"Madness Hyperactive"
		,TitleFont:"Madness Hyperactive"
		,Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico"
		,Animate:"Right,Slide"
	...
	Notify().AddWindow("On the Clipboard!" ;~ Remove "" if want to use a variable, NO percents!
		,{Title:"Removed Extra Spaces from Clipboard"
		,Font:"Sans Serif"
		,TitleFont:"Sans Serif"
...
else if(MasterScriptCommands = "purge kontakt"){ ;~ Name of Command
	gui_destroy()
	SN:= 50 ;~ Sleep Number
...
else if(MasterScriptCommands = "purge vepro"){ ;~ Name of Command
	gui_destroy()
	Run, "C:\AHK Scripts\Kontakt Purge All v1.00 DMD.ahk"
}
else if(MasterScriptCommands = "shorcut notion"){ ;~ Name of Command
	gui_destroy()
	CLipboard:= StrReplace(Clipboard, "https","notion",1)
	Notify().AddWindow(Clipboard
		,{Title:"Notion GLobal Link"
		,Font:"Madness Hyperactive"
		,TitleFont:"Madness Hyperactive"
		,Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico"
		,Animate:"Right,Slide"
...
else if(MasterScriptCommands = "global link"){ ;~ Name of Command
	gui_destroy()
	...
	gui_destroy()
	;~ Run, "C:\AHK Scripts\_Master Script\Run\Shortcuts\AHK-Studio - Shortcut.lnk"
...
else if(MasterScriptCommands = "Cubase template"){ ;~ Load Cubase Template
	gui_destroy()
...
;~ Ways that the window will animate in eg. {Animate:""} Can be Bottom, Top, Left, Right, Slide, Center, or Blend (Some work together, and some override others)
	...
	gui_destroy()
	;~ DMD_RunShortcut("C:\Program Files\Quick Access Popup\QuickAccessPopup-64-bit.exe")
	Run, "C:\Program Files\Quick Access Popup\QuickAccessPopup-64-bit.exe"
}
...
else if(MasterScriptCommands = "reminder tax on stock sell"){ ;~ Name of Command
	gui_destroy()
	Msgbox
	(
