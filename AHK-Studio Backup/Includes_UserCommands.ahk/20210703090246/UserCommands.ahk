...
;~ Ways that the window will animate in eg. {Animate:""} Can be Bottom, Top, Left, Right, Slide, Center, or Blend (Some work together, and some override others)
	...
	; C:\Program Files\Quick Access Popup\QuickAccessPopup-64-bit.exe
	m(SplitPath(vQAP).dir)
	;~ SplitPath("") ;~ Filename|Dir|Ext|NNE|Drive
	;~ Run, % vQAP, % vQAP
	;~ Run *RunAs %ComSpec% /k %vQAP% ;~ /k keep CMD window open after command || /c close CMD windowe after command
}
