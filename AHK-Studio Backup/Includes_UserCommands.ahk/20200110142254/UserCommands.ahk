...
;~ Gui,Show
	...
	gui_destroy()
	Focus_Send({Window:"Sibelius ahk_class Qt5QWindowIcon",Keys:"^t{Sleep 50}a2{Escape}{Sleep 1000}^t",Title:"a2 Players",Background:"#6D4478",TitleMatchMode:"2",Icon:"Sibelius"})
}