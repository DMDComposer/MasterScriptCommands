...
else if(MasterScriptCommands = "lf"){ ;~ Testing area
	gui_destroy()
...
;--------------------------------------------------------------------------------
	...
	for Key,Value in oDirs
	{
		if (Key ~= "i)" MasterScriptCommands) 
		{
			...
			if (Value ~= "%A_Username%" ? Value := StrReplace(Value, "%A_Username%", A_UserName) : Value := Value)
				if (Value ~= "%UserProfile%" ? Value := StrReplace(Value, "%UserProfile%", A_UserProfile) : Value := Value)
					Run, % Value
		}
	}
}
	...
	;~ vIni_Key     := (vType == "icon" ? "icons." vNew_Key : vNew_Key ~= "i)" vNew_Key)
	...
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"D:\Folder Icons\IOS Icons\Clay Icons - By octaviotti\ICO\Internet Download Manager.ico", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	RegRead, vFolder, HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\User Shell Folders, {374DE290-123F-4565-9164-39C4925E467B} ;~ I believe more accurate way to get Download Folder location
	Run % vFolder
}
else if(MasterScriptCommands = "documents"){ ;~ Documents
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	RegRead, vFolder, HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\User Shell Folders, {F42EE2D3-909F-4907-8871-4C22FC0BF756} 
	Run % vFolder	
}
else if(MasterScriptCommands = "Video"){ ;~ Video
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	RegRead, vFolder, HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\User Shell Folders, {35286A68-3C57-41A1-BBB1-0EAE73D76C95} 
	Run % vFolder	
}
else if(MasterScriptCommands = "Music"){ ;~ Music
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	RegRead, vFolder, HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\User Shell Folders, {A0C69A99-21C8-4671-8703-7934162FCF1D} 
	Run % vFolder	
}
else if(MasterScriptCommands = "Pictures" || MasterScriptCommands = "pics"){ ;~ Pictures
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	RegRead, vFolder, HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\User Shell Folders, {0DDD015D-B06C-45D5-8C4C-F59713854639} 
	Run % vFolder	
}
else if (MasterScriptCommands = "drop" || MasterScriptCommands = "Dropbox"){ ;~ Dropbox folder
	gui_destroy()
	...
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon: "C:\Program Files (x86)\Dropbox\Client\Dropbox.exe, 49", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	Run, %Var%
}
...
;-------------------------------------------------------------------------------
	...
	gui_search_title:= "What would you like to search?"
	gui_Change_Title("Search Thesaurus","#E62522",Icon_YouTube)
	gui_search("https://www.thesaurus.com/browse/REPLACEME?s=t")	
}
else if(MasterScriptCommands = "dic. "){ ;~ Search Dictionary
	gui_search_title:= "What would you like to search?"
	gui_Change_Title("Search Dictionary","#E62522",Icon_YouTube)
	...
	gui_search_title:= "What would you like to search?"
	gui_Change_Title("Search Youtube","#E62522",Icon_YouTube)
...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	Toggle_App("Calc", A_WinDir "\System32\calc.exe")
}
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
;~ /////////////////////////////////////////              //////////////////////////////////////////
;~ ///////////////////////////////////////// AHK Scripts  //////////////////////////////////////////
...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	Run, A_Dropbox "\AHK Scripts\Tools\Encryption Tool\Encryption User Tool.ahk"
}
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
;~ /////////////////////////////////////////              //////////////////////////////////////////
;~ ///////////////////////////////////////// Quick Links  //////////////////////////////////////////
...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\Program Files\Quick Access Popup\icons\Distrokid.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	DMD_RunShortcut(A_Dropbox "\AHK Scripts\Tools\Chrome\Distrokid Weekly Vote\Distrokid Weekly Vote.ahk")
}
;-------------------------------------------------------------------------------
...
;-------------------------------------------------------------------------------
	...
	gui_destroy()
	Run, % A_ProgramFiles64 """C:\Program Files\Notepad++\notepad++.exe """ A_WinDir """\System32\drivers\etc\hosts"""	
}
else if(MasterScriptCommands = "date" || MasterScriptCommands = "the date"){ ;~ Date
	gui_destroy()
...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	gui_destroy()
	Run, % A_Dropbox "\AHK Scripts\Tools\AU3_Spy.exe",,,001
	WinWaitActive, ahk_pid %001%
	WinMove,ahk_pid %001%,,1571,0
	Sleep, 100
	Run, % A_Dropbox "\AHK Scripts\Tools\WinSpy\WinSpy.ahk",,,002
	...
	gui_destroy()
	DMD_RunShortcut(A_Dropbox "\AHK Scripts\API Calls\Captilize My Title\Captilize My Title API.ahk")
}
	...
	DMD_RunShortcut(A_Dropbox "\AHK Scripts\Audio Image Video\ImageMagick\Base64 Images.ahkf")
}
...
else if(MasterScriptCommands = "amt"){ ;~ Automate My Task
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	gui_destroy()
	Notify().AddWindow("Empty RecycleBin", {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:A_GoogleDrive "\Folder Icons\WIndows 10 Icons\imageres_54.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x0489D8", TitleColor:"0x0489D8"})
	...
	gui_destroy()
	ydl   := "" A_Dropbox "\AHK Scripts\Tools\Youtube Downloader\youtube-dl.exe"""Chr(32)
	...
	*/
	...
	gui_destroy()
	Toggle_App("Notion", A_AppDataLocal "\Programs\Notion\Notion.exe")
}
	...
	*/
	...
	gui_destroy()
	Run, % A_Dropbox "\AHK Scripts\Tools\Magick\Compress Image.ahk"
}
else if(MasterScriptCommands = "action"){ ;~ Action Zone
	gui_destroy()
	Toggle_App("Action Zone", A_AppDataLocal "\Programs\Notion\Notion.exe")
}
else if(MasterScriptCommands = "task"){ ;~ AHK Task Manager
	gui_destroy()
	Run, % A_Dropbox "\AHK Scripts\Tools\Task Manager\TaskManager.ahk"
	...
	gui_destroy()
	DMD_RunShortcut(A_Dropbox "\AHK Scripts\Audio Image Video\Toggle Default Audio Device.ahk")
}
else if(MasterScriptCommands = "messenger"){ ;~ Run Faceboook Messenger
	gui_destroy()
	Run, % A_ProgramFiles64 "\WindowsApps\FACEBOOK.317180B0BB486_720.6.119.0_x64__8xx8rvfyw5nnt\app\Messenger.exe"
}
	...
	gui_destroy()
	Run, % A_Dropbox "\AHK Scripts\Tools\Volume Per Application.ahk"
}
else if(MasterScriptCommands = "to ico"|| MasterScriptCommands = ".ico"){ ;~ Convert Image on Clipboard to Ico
	gui_destroy()
	DMD_RunShortcut(A_Dropbox "\AHK Scripts\Audio Image Video\ImageMagick\Convert to ICO.ahk")
}
	...
	gui_destroy()
	Run, % A_Dropbox "\AHK Scripts\Tools\AHK Screen Recording\Screen Recording.ahk"
}
	...
	gui_destroy()
	oObj := ["https://www.newegg.com/amd-ryzen-9-5900x/p/N82E16819113664"
	        ...
	        ,"https://www.microcenter.com/product/630283/amd-ryzen-9-5900x-vermeer-37ghz-12-core-am4-boxed-processor"
	        ,"https://www.amazon.com/Ryzen-5900X-12-Core-Desktop-Processor/dp/B08NXYLBN5"
	        ,"https://www.amd.com/en/where-to-buy/ryzen-5000-series-processors"
	        ,"https://www.walmart.com/ip/AMD-Ryzen-9-5900X-12-core-24-thread-Desktop-Processor/647899167?irgwc=1&sourceid=imp_V-k1NFz4UxyLRBgwUx0Mo388UkERS3R5wWfWUQ0&veh=aff&wmlspartner=imp_62662&clickid=V-k1NFz4UxyLRBgwUx0Mo388UkERS3R5wWfWUQ0&sharedid=&affiliates_ad_id=612734&campaign_id=9383"]
	for Key, Value in oObj
		Run, % Value
}
	...
	DMD_Run(comspec " /k", A_WinDir "\System32\")
}
	...
	Run, "F:\Dorico",,UseErrorLevel
	/*
		if ErrorLevel
			Msgbox, 16, % "ERROR "A_LastError, % GetErrorStr(15)		
	*/
}
	...
	gui_destroy()
	Run, % A_ProgramFiles "\Adobe\Photoshop\Photoshop.exe"
...
else if(MasterScriptCommands = "process explorer" || MasterScriptCommands = "proc explorer"){ ;~ Run Process Explorer
	gui_destroy()
...
else if(MasterScriptCommands = "process monitor" || MasterScriptCommands = "proc mon"){ ;~ Run Process Monitor
	gui_destroy()
...
else if(MasterScriptCommands = "registry changes" || MasterScriptCommands = "reg changes"){ ;~ Run Registry Changes
	gui_destroy()
...
else if(MasterScriptCommands = "doge"){ ;~ Run DodgeCoin Stocks Fav Windows/Tabs
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
...
else if(MasterScriptCommands = "keyboard OSD"){ ;~ Keyboard OSD
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	DMD_RunShortcut("C:\AHK Scripts\Tools\KeyboardOSD\KeysPressedOSD.ahk")
}
else if(MasterScriptCommands = "edit dirs"){ ;~ Edit Directory Paths
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	Run, % "C:\AHK Scripts\_Master Script\Run\Master Search Box\Includes\Directory Paths.ini"
}
else if(MasterScriptCommands = "temp"){ ;~ Open Temp Folder
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	Run % A_Temp
}
else if(MasterScriptCommands = "message spy"){ ;~ Run Spy++ to catch window messages
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	Run, % A_ProgramFiles "\Microsoft Visual Studio\2017\Community\Common7\Tools\spyxx.exe"
}
else if(MasterScriptCommands = "msconfig"){ ;~ MSConfig
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
