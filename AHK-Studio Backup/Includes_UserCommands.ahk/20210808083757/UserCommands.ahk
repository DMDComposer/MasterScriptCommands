...
;--------------------------------------------------------------------------------
	...
	Loop, Files, % vPath "\*.*", F 
	{
		if (A_LoopFileFullPath ~= "i)desktop.ini"){
			IniRead, vIniIcon, % A_LoopFileFullPath, % ".ShellClassInfo", % "IconResource"
			vIcon := vIniIcon != Space ? vIniIcon : "C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1"
		}
		vIcon := A_LoopFileFullPath ~= "i).ico" ? A_LoopFileFullPath : vIcon ; If folder has a *.ico, use that as Icon.
	}
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:vIcon, Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
}
...
else if(MasterScriptCommands = "filepath to js esc \\"){ ;~ Convert file path with double \\
	gui_destroy()
	Clipboard := RegExReplace(Clipboard,"\\","\\")
	Notify().AddWindow(Clipboard, {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
}