...
;~ Ways that the window will animate in eg. {Animate:""} Can be Bottom, Top, Left, Right, Slide, Center, or Blend (Some work together, and some override others)
  ...
  . "`nVersion : " . objBiosItem.Version)
	...
	Gui infoPC: Add, ListView, x0 y0 r45 w600 vMyLV, Attribute|Value
	...
	While colSettings[strCSItem]
	{
		...
		LV_Add("","TotalPhysicalMemory",Round(strCSItem.TotalPhysicalMemory/(1024*1024),0) . " MB" "   |   " Round(strCSItem.TotalPhysicalMemory/(1024*1024)/1024,0) . " GB")
	...
	GuiControl, +Redraw, MyLV
	LV_ModifyCol()
	Gui infoPC: Show, AutoSize, Computer Details
	Return
