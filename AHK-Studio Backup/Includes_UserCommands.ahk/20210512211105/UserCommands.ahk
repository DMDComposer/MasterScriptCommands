...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	Notify().AddWindow("Running Adobe Photoshop" ;~ Remove "" if want to use a variable, NO percents!
		,{Title:""
		,Font:"Sans Serif"
		,TitleFont:"Sans Serif"
		,Icon:"C:\Program Files\Adobe\Photoshop\Photoshop.exe, 1" ;~  Can be either an Integer to pull an icon from Shell32.dll or a full path to an EXE or full path to a dll.  You can add a comma and an integer to select an icon from within that file eg. {Icon:"C:\Windows\HelpPane.exe,2"}
