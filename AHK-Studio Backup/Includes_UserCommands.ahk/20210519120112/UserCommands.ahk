...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	Notify().AddWindow(mymac
		,{Title:"Troublemaker MAC: Address"
		,Font:"Madness Hyperactive"
		,TitleFont:"Madness Hyperactive"
		,Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico"
		,Animate:"Right,Slide"
...
else if(MasterScriptCommands = "TotalMix"){ ;~ Name of Command
	gui_destroy()
...
else if(MasterScriptCommands = "wintitle" || MasterScriptCommands = "window title"){ ;~ Name of Command
	gui_destroy()
	WinGetTitle, T, A
	Clipboard:= T
	Notify().AddWindow(T
