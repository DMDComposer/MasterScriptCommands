...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	Perform_Action({Type:"Mouse",Action:"Left",Actual:0,ClickCount:1,RestorePOS:0,Wait:2,WindowWait:2,Comment:"Mouse Click",Match:1,OffsetX:-119,OffsetY:43,Area:vWindow,Bits:"zzzzzzzzzzzzzzzzzzzzzSrzrhzyvTyyrzjhzsPTxyrzzhzzzzzzzzzzzzzzzzzzzzy",Ones:374,Zeros:26,Threshold:129,W:20,H:20})	
	If (vState = -1)
		WinMinimize, % vWindow	
}
