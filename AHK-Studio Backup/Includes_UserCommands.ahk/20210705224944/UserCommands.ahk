vIni_Dir_Path  := A_LineFile "\..\Directory Paths.ini"
...
if (MasterScriptCommands = "ahk "){ ;~ Search for AHK Related Info
...
else if(MasterScriptCommands = "lf"){ ;~ Name of Command
	gui_destroy()
	...
	;~ m(A_LineFile)
	IniRead, vVar, % A_LineFile "\..\Directory Paths.ini"
	m(vVar)
}
;-------------------------------------------------------------------------------
;;; LAUNCH DIRECTORIES ;;;
;--------------------------------------------------------------------------------
	...
	/*
		if (RegExMatch(text, "i)A|B|C|she"))
			if (text~="i)A|B|C|she")
	*/			
	...
	HS_Dir := A_LineFile "\..\..\_Master Script\HS_Dir Paths.ahk"                    ; edit with your full script path	
...
;-------------------------------------------------------------------------------
	...
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	Run, "D:\Program Files (x86)\iconsext\iconsext.exe",, UseErrorLevel
	if ErrorLevel
		m("Can't Find Program...")
}
...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	Sleep, 100
	Run, "C:\AHK Scripts\Tools\WinSpy\WinSpy.ahk",,,002t
	...
	gui_destroy()
	DMD_RunShortcut("C:\AHK Scripts\rAPI Calls\Captilize My Title\Captilize My Title API.ahk")
}
	...
	DMD_RunShortcut("C:\AHK Scripts\Audio Image Video\ImageMagick\Base64 Images.ahkf")
}
else if(MasterScriptCommands = "script icons"){ ;~ Master Script Icon List
	gui_destroy()
	; C:\AHK Scripts\_DMD Scripts\_Master Script\Resources\Icons.ini
	;C:\Users\DMDCo\Dropbox\AHK Scripts\_DMD Scripts\_Master Script\Resources\Icons.ini
	;~ m(A_Dropbox)
	Msgbox  % A_ProgramFiles64 "\Notepad++\notepad++.exe" A_Space chr(34 )A_Dropbox "\AHK Scripts\_DMD Scripts\_Master Script\Resources\Icons.ini" chr(34)
	;~ Run, % A_ProgramFiles64 "\Notepad++\notepad++.exe" A_Space A_Dropbox chr(34) "\AHK Scripts\_DMD Scripts\_Master Script\Resources\Icons.ini" chr(34)
}
...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:Icon_MSCDefault, Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	DMD_RunShortcut("C:\AHK Scripts\_DMD Scripts\Master Search Box\UserCommand Run Scripts\Mixer.ahk")
}
...
;~ Ways that the window will animate in eg. {Animate:""} Can be Bottom, Top, Left, Right, Slide, Center, or Blend (Some work together, and some override others)
	...
	gui_destroy()
	Run, "C:\Program Files\ProcessMonitor\Procmon.exe"
	...
	gui_destroy()
	Run, "C:\Program Files\Registry Changes View\RegistryChangesView.exe"
	Notify().AddWindow("Running Process Monitor", {Title:"Run Procexp64.exe", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\Program Files\ProcessExplorer\procexp64.exe, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
}
	...
	gui_destroy()
	DMD_RunShortcut("D:\Users\Dillon\Dropbox\AHK Scripts\_DMD Scripts\OSC Install New Version.ahk")
}
  ...
  . "`nEmbedTest : " . objBiosItem.EmbeddedControllerMajorVersion)
	...
	gui_destroy()
	DMD_RunShortcut("C:\AHK Scripts\_DMD Scripts\Master Search Box\UserCommand Run Scripts\Info Computer System.ahk")	
}
   ...
   . "Status,Tag,Version,Weight,Width"
	...
	gui_destroy()
	DMD_RunShortcut("C:\AHK Scripts\_DMD Scripts\Master Search Box\UserCommand Run Scripts\Info OS.ahk")
}
