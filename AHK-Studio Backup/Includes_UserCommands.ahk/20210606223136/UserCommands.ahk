...
;~ Chr(34) = quotes
;~ Chr(37) = %
oDir := {"down":"D:\Users\Dillon\Downloads"
		,"dir obs":"D:\OBS Capture"}
oIcon_Dirs := {"icons.cmd":"C:\Windows\System32\cmd.exe"
,"icons.cubase":"C:\Program Files\Steinberg\Cubase 11\Cubase11.exe"
,"icons.dorico":"C:\Program Files\Steinberg\Dorico3.5\Dorico3.5.exe"}
...
;;; LAUNCH DIRECTORIES ;;;
;--------------------------------------------------------------------------------
else if(oDir.HasKey(MasterScriptCommands)){ ;~ Testing Directory Objects
	gui_destroy()
	...
	for Key,Value in oDir
	{
		if (Key == MasterScriptCommands)
		Run, % Value
	}
}
else if(oIcon_Dirs.HasKey(MasterScriptCommands)){ ;~ Icon Directory
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	for Key,Value in oIcon_Dirs
	{
		if (Key == MasterScriptCommands)
		{
...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	gui_destroy()
	;~ RegRead, Var,HKCR\CLSID\{E31EA727-12ED-4702-820C-4B6445F28E1A}\Instance\InitPropertyBag,TargetFolderPath ;~ Getting GDrive Location
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\Program Files\Google\Drive\googledrivesync.exe, 10", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	;~ Run, %Var%
