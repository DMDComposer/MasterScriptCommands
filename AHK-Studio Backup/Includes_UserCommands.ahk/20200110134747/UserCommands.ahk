...
;~ Gui,Show
	...
	gui_destroy()
	Focus_Send({Window:"Sibelius ahk_class Qt5QWindowIcon",Keys:"^t{BACKSPACE}{Sleep 10}a2{Escape}{Sleep 10}^t{BACKSPACE}{Sleep 10}~C104, 2{Escape}",Title:"Show or Hide Hidden Objects",Background:"#6D4478",TitleMatchMode:"2",Icon:"Sibelius"})
}