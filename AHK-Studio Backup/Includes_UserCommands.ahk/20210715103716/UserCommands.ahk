...
;;; LAUNCH DIRECTORIES ;;;
;--------------------------------------------------------------------------------
else if(oDirs.HasKey(MasterScriptCommands)){ ;~ Running Directory Paths
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	for Key,Value in oDirs
	{
		if (Key ~= "i)^" MasterScriptCommands "|dir\s" MasterScriptCommands) 
		{
			...
			if (Value ~= "A_GoogleDrive" ? Value := StrReplace(Value, "A_GoogleDrive", A_GoogleDrive) : Value := Value)
			if (Value ~= "A_Dropbox" ? Value := StrReplace(Value, "A_Dropbox", A_Dropbox) : Value := Value)
			Run, % Value
		}
	}
}
...
;------------------------------------------------------------------------------
	...
	gui_search_title:= "What would you like to search?"	
	gui_Change_Title("Search Torrent Networks","#00FF00", "D:\Users\Dillon\Google Drive\Folder Icons\_DMD Fav Icons\scripts.ico")
	...
	gui_search([Chrome " https://rutracker.org/forum/tracker.php?nm=REPLACEME"
	           ,Chrome " https://audioclub.in/?s=REPLACEME"
	           ,Chrome " https://audioz.download/"
	           ,Chrome " https://www.1377x.to/search/REPLACEME/1/"
	           ,Chrome " https://courseboat.com/gsearchv4/?q=REPLACEME"])
...
;-------------------------------------------------------------------------------
	...
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	Run, % A_ProgramFiles "\Steam\steam.exe",,UseErrorLevel
}
...
else if(MasterScriptCommands = "scripts"){ ;~ Open Script Directory
	gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
