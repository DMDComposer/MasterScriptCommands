...
WinGetPos,ADGx,ADGy,ADGw,ADGh,ahk_id Add_Command_GUI
DebugWindow(ADGw,Clear:=0,LineBreak:=1,Sleep:=250,AutoHide:=0)
Gui, Add, Button, w%ADGw% gAdd_Command_Button, Add Command
...
#IfWinActive ahk_id Add_Command_ID
Tab::SendInput, {Space 4}
#IfWinActive

Add_Command_Button:
Gui, Submit, NoHide ;~ Needed to add custom input
MsgBox,262193,Save Command,Overwrite User Commands?
IfMsgBox, OK
{	
