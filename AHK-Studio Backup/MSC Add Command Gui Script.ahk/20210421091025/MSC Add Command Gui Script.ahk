...
Add_Command_Button:
Gui, Submit, NoHide ;~ Needed to add custom input
UC_File:="D:\Users\Dillon\Documents\Testing FileAppend.txt"
Final_Line:=TF_CountLines(UC_File) ; store the number of lines of file in a variable
TF_InsertLine(UC_File,Final_Line-1,Add_Command)     ; insert --- in lines 2 4 and 9. 5 is endline will be ignored
