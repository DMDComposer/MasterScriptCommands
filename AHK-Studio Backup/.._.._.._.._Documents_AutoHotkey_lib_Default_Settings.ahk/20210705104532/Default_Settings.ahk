...
EnvGet, A_SystemDirectory, SystemDirectory
if (A_PtrSize == 4)
	A_ProgramFiles64 := StrReplace(A_ProgramFiles64, " (x86)", "") ;~ Replace (x86) in string
;~ Global variables
Global A_UserProfile, A_ProgramFiles64, A_Dropbox, A_SystemDirectory, SN:=50, A_Return:=A_Enter:="r'n"    ;Create my variables
