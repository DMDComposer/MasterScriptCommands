...
;~ Standard GUI
Gui Main: Margin, , % MSC_Margin
Gui Main: Color, 1d1f21, 282a2e
Gui Main: +AlwaysOnTop -SysMenu +ToolWindow -caption +Border hwndMSC_GUI									  ;~ Removes header/toolbar/menu from IE Window

IE := FixIE(11)
Gui Main:Add,ActiveX,vWB w%MSC_Height% h%MSC_IconSize% hwndhID,mshtml										  ;~ The final parameter "mshtml" is the name of the ActiveX component
FixIE(IE)
HTML=
(
...
Gui Main: Add, Edit, xs w%MSC_Width% cc5c8c6 -E0x200 vMasterScriptCommands gFindus HWNDQueryEditField                ;~ Search edit field
...
Gui Main: Add, Text, xs-(%IconW%/2) w%MSC_Width% -E0x200 %cYellow% +Center vGui_Search_title_var, %gui_search_title% ;~ Edit "What would you like to search?" Text
Gui Main: Add, Edit, xs w%MSC_Width% -E0x200 %cYellow% vgui_SearchEdit -WantReturn hWndhEdtValue2 
...
Gui Main: Font, s10 cffffff, Consolas
Gui Main: Color, 0x1d1f21, 0x1d1f21
Gui Main: Add, ListBox, xs y100 w%MSC_Width% h%MSC_Height% vGui_Display -HScroll +VScroll +0x300000 -E0x200 Choose1 HWNDGUI_Intel_Edit_Field,									;~ Listbox
...
Gui Main: Add, Button, Hidden Default, OK
Gui Main:, Show, AutoSize, MasterScriptCommands
