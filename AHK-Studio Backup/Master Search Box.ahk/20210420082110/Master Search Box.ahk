...
Gui, Add, Edit, %gui_control_options% vMasterScriptCommands gFindus vFindusEditField
Gui, Show,, myGUI
Return
...
ControlGetPos, X, Y,,,, % "ahk_id" FindusEditField ;~ Get position of Query Edit Field to Place Tooltip Below
ToolTip_Font("s10", "Segoe UI")
ToolTip_Color("0x1d1f21", "0xffffff")
Tooltip, % Sift_Regex((Findus = "" ? Data = "" : Data:= Data), Findus, Options), % X, % Y+10
if (Findus = "") ;~ Remove Tooltip if Blank
{
	ToolTip,,, 
}
