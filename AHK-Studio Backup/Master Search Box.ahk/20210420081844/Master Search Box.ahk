...
Gui, Add, Edit, %gui_control_options% vMasterScriptCommands gFindus gQuery, text
Gui, Show,, myGUI
Return
...
Tooltip, % Sift_Regex((QueryText = "" ? Data = "" : Data:= Data), QueryText, Options), % X, % Y+10
if (QueryText = "") ;~ Remove Tooltip if Blank
{
	ToolTip,,, 
}
