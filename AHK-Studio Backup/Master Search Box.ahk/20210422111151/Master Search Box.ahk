...
DebugWindow(gui_control_options,Clear:=0,LineBreak:=1,Sleep:=250,AutoHide:=0)
...
Gui, Add, Text, %gui_control_options% vgui_main_title +Center HWNDMSC_Title, Master Script Commands
