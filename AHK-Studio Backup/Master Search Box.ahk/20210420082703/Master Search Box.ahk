...
FileRead, Data, C:\AHK Scripts\_Master Script\Run\Master Search Box\MSC Commands.ini ;~ Read Commands for Tooltip
...
Icon:="C:\Program Files\Steinberg\Dorico3.5\Dorico3.5.exe, 1" ;~ Add icon to Main GUI Spawn
...
Gui, Add, Edit,  x130 y40 w400 h400 vGui_Display ReadOnly +0x300000 -E0x200 -wrap -WantReturn HWNDQueryEditField, ;~ Edit Query Field
...
Gui, Show, AutoSize
Display := Sift_Regex((QueryText = "" ? Data = "" : Data:= Data), QueryText, Options)
...
/*
	...
	ToolTip_Font("s10", "Segoe UI")
	ToolTip_Color("0x1d1f21", "0xffffff")
	Tooltip, % Sift_Regex((MasterScriptCommands = "" ? Data = "" : Data:= Data), MasterScriptCommands, Options), % X, % Y+10
...
FileRead, Data, C:\AHK Scripts\_Master Script\Run\Master Search Box\MSC Commands.ini
#Include MSC Commands.ini.ahk
Display := Data
Options := "in"
NgramSize := 3
NgramLimit := .50
