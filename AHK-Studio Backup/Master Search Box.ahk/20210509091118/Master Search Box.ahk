...
IE := FixIE(11)
Gui,Add,ActiveX,vwb w%MSC_Height% h%MSC_IconSize% vgui_main_title HWNDMSC_Title,mshtml						;~ Have to have some sort of text otherwise it'll error out
FixIE(IE)
...
GuiControl, Move, %MSC_Title%, % "w" Width "h" MSC_IconSize "x" ((MSC_Width-Width)/2)+(IconW/2)			;~ Moving HTML & Centering it Above Edit Field
