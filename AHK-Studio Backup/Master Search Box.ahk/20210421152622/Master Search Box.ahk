...
Icon:="C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 2" ;~ Add icon to Main GUI Spawn
...
*/
Gui, Add, Picture, w32 h32,% "HBITMAP:" LoadPicture(Icon,"GDI+ w32 h32",2)
