...
Loop, read, C:\AHK Scripts\_Master Script\Run\Master Search Box\Includes\UserCommands.ahk
{
...
Sifted_Text:= Sift_Regex((QueryText = "" ? Data = "" : Data:= Data), QueryText, Options)
