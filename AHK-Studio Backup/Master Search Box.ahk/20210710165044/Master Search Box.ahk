...
gui_change_title(Message,Color := "",Icon := "") {
	...
	if (Icon = Space  ? Notify().AddWindow("haha", {Title:""}))
	Icon := "" ? Icon := A_Dropbox "\AHK Scripts\_DMD Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico" : Icon := Icon
