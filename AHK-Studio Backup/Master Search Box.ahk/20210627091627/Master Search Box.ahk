...
GuiControl, Move, %hID%, % "Section " "w" Width "h" MSC_IconSize "x" ((MSC_Width-Width)/2)+(IconW)                       ;~ Moving HTML & Centering it Above Edit Field
Clipboard := MSC_Width A_Space Width A_Space IconW
