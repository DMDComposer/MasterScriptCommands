...
Gui, Add, Text, xm w600 cc5c8c6 -E0x200 +Center vgui_main_title HWNDMSC_Title, Master Script Commands ;~ Title
Gui, Font, s10, Segoe UI
Gui, Add, Edit, xm w220 cc5c8c6 -E0x200 vMasterScriptCommands gFindus HWNDQueryEditField ;~ Search edit field
...
Gui, Add, Edit,  xp y+m w600 h100 vGui_Display ReadOnly +0x300000 -E0x200 +0x200000  -0x100000 -wrap -WantReturn HWNDGUI_Intel_Edit_Field, BLAGR! ;~ Edit Query Field
GuiControl, Hide, GUI_Intel_Edit_Field
...
;~ Tooltip for Intellisense
Tooltip_Intellisense:
...
ToolTip % st_columnize(Sifted_Text, "csv", 1,,A_Tab), % X-16, % Y+45 ;~ justify everything correctly. 3 = center, 2= right, 1=left.
WinGet, HTT, ID, ahk_class tooltips_class32 ahk_exe %A_AhkPath%
WinGetPos,TTx,TTy,TTw,TTh,ahk_id %HTT%
if (TTh>700)
{
	WinGetPos,MSx,MSy,MSw,MSh,ahk_id %MSC_GUI%
	;~ WinMove,ahk_id %HTT%,,834,567,,	
	WinMove,ahk_id %HTT%,,% MSx,567,,	
}
