...
Gui, Add, Edit,  xs y+m w%MSC_Width% h%MSC_Height% vGui_Display ReadOnly +0x300000 -E0x200 +0x200000  -0x100000 -wrap -WantReturn WantTab HWNDGUI_Intel_Edit_Field, BLAGR! ;~ Edit Query Field
...
Gui, Add, Text, xs w%MSC_Width% -E0x200 %cYellow% +Center, %gui_search_title%
