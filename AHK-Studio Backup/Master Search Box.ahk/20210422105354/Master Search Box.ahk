...
Gui, Add, Edit,  x130 y40 w600 h100 vGui_Display ReadOnly +0x300000 -E0x200 +0x200000  -0x100000 -wrap -WantReturn HWNDGUI_Intel_Edit_Field, Testing ;~ Edit Query Field
...
ToolTip % st_columnize(Sifted_Text, "csv", 2,,A_Tab), % X-16, % Y+45
...
Gui, Show, AutoSize
Sifted_Text:= Sift_Regex((MasterScriptCommands = "" ? Data = "" : Data:= Data), MasterScriptCommands, Options)
Display:= st_columnize(Sifted_Text, "csv", 2,,A_Tab)
