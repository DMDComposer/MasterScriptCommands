...
WinGetPos,GIx,GIy,GIw,GIh,ahk_id %hEdtValue2%
DebugWindow(GIx `n GIy `n GIw `n GIh,Clear:=0,LineBreak:=1,Sleep:=250,AutoHide:=0)

Gui, Add, Edit, xs y%GIy% w%MSC_Width% h%MSC_Height% ReadOnly +0x300000 -E0x200 +VScroll  -HScroll -wrap -WantReturn -Tabstop vGui_Display HWNDGUI_Intel_Edit_Field, BLAGR! ;~ Edit Query Field
...
;~ Reset/Hide Tooltip Intellisense
ToolTip,,,
