...
gui_change_title(Title,Subtitle := "test",Color := "",Icon := "") {
	...
	global WB, MSC_Title, Subtitle, MSC_Background, MSC_Color, MSC_Icon, MSC_Radius, MSC_Font, MSC_FontSize, MSC_Width, MSC_Height, MSC_Margin, MSC_IconSize, IconW, IconH, Img
...
{
	Run % StrReplace(Value, "REPLACEME", uriEncode(gui_SearchEdit))
