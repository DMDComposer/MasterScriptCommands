...
DebugWindow(GIx GIy,Clear:=0,LineBreak:=1,Sleep:=250,AutoHide:=0)

Gui, Add, Edit,  xs y+m w%MSC_Width% h%MSC_Height% vGui_Display ReadOnly +0x300000 -E0x200 +VScroll  -HScroll -wrap -WantReturn -Tabstop WantTab HWNDGUI_Intel_Edit_Field, BLAGR! ;~ Edit Query Field
