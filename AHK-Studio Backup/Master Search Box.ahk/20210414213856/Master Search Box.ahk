...
;~ Menu, Tray, Icon, "C:\AHK Scripts\_Master Script\Run\Master Search Box\Hyper.ico", 1 ;~ Set Icon of Script in Taskbar
;~ Menu, Tray, NoIcon
...
Gui, Add, Text, %gui_control_options% vgui_main_title, Master Script Commands
...
Loop, %command_inputs%
{
	StringReplace, command_final_input, command_input%A_Index%, ReplaceMe, %query_safe%
		;~ Gui_Command_Exe(command_final_input)
}
command_inputs:= 0
Return
