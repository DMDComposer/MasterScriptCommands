...
gui_change_title(message,color = "") {
	...
	WB.Document.GetElementsByTagName("span").item[0].Value := message 							;~ Set Tag name and Array value
	DebugWindow(WB.Document.GetElementsByTagName("span").item[0].Value := message,Clear:=0,LineBreak:=1,Sleep:=250,AutoHide:=0)
	/*
