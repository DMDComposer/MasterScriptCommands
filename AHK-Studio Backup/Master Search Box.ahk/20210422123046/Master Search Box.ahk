...
Gui, Add, Edit, x%GIx%+m y%GIy%-%GIh% w%MSC_Width% h%MSC_Height% ReadOnly +0x300000 -E0x200 +VScroll  -HScroll -wrap -WantReturn -Tabstop vGui_Display HWNDGUI_Intel_Edit_Field, BLAGR! ;~ Edit Query Field
