...
Icon_MSCDefault := "C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico"
...
MSC_RoundedEdges(height := 105){
	Global MSC_Width, MSC_Height, MSC_Radius
	GUI +LastFound
	WinSet, Region, 0-0 w%MSC_Width% h%height% R%MSC_Radius%
}

MSC_GetGuiSize(){
	;~ Gui, +LastFound
	Global MSC_GUI
	WinGetPos, x, y, w, h, ahk_id %MSC_GUI%
...
MSC_RoundedEdges(MSC_GetGuiSize().h)
