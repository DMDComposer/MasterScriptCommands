...
Menu, Tray, Icon, 'C:\AHK Scripts\_Master Script\Run\Master Search Box\Master Search Box.ico', 1 ;~ Set Icon of Script in Taskbar
...
if gui_state != closed
{
    ...
    Gui, Add, Text, %gui_control_options% vgui_main_title, Master Script Commands ;~¯\_(ツ)_/¯
