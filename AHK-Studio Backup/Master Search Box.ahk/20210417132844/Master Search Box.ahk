...
Loop, %search_urls%
{
	...
	;~ If (Title != Search_Title ? Title:= New_Title : Title:= Search_Title)
	If (Title != Search_Title ? Title:= "Does Not Match" : Title:= "Does Match")	
		
	
	;~ msgbox % "OG TITLE: "Title A_Tab "Search_Title:= "Search_Title
