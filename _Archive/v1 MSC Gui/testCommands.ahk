...
if (MasterScriptCommands = "lf"){ ;~ Testing area
	; gui_destroy()
...
;;; LAUNCH DIRECTORIES ;;;
;--------------------------------------------------------------------------------
else if(oDirs.HasKey(MasterScriptCommands) || oDirs.HasKey("dir " MasterScriptCommands)){ ;~ Running Directory Paths
	; gui_destroy()
...
;------------------------------------------------------------------------------
...
else if(MasterScriptCommands = "magick"){ ;~ Magick
	; gui_destroy()
...
else if(MasterScriptCommands = "kill cubase"){ ;~ Kill Cubase
	; gui_destroy()
...
else if(MasterScriptCommands = "kill firefox"){ ;~ Kill Firefox
	; gui_destroy()
...
else if(MasterScriptCommands = "kill protools"){ ;~ Kill Pro Tools
	; gui_destroy()
...
else if(MasterScriptCommands = "fix elicenser"){ ;~ Fix Elicenser / Kill Synsopos
	; gui_destroy()
...
else if(MasterScriptCommands = "backup music"){ ;~ Backup
	; gui_destroy()
...
else if(MasterScriptCommands = "website stuff"){ ;~ open folder to website stuff
	; gui_destroy()
...
else if(MasterScriptCommands = "kill vscode"){ ;~ Kill TeamViewer
	; gui_destroy()
	Process, Close, Code.exe

}
else if(MasterScriptCommands = "kill kontakt"){ ;~ Kill Kontakt
	; gui_destroy()
...
else if(MasterScriptCommands = "edit Dorico commands"){ ;~ Open Dorico Usermacro Location
	; gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	Run, % A_AppData "\Steinberg\Dorico 3.5\Script Plug-ins"
}
else if(MasterScriptCommands = "backup dorico"){ ;~ Backup Dorico
	; gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	DMD_Run(A_Dropbox "\AHK Scripts\_DMD Scripts\Dorico Settings Backup & Restore.ahk")
}
else if(MasterScriptCommands = "network sharing"){ ;~ Network Sharing Control Panel
	; gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	Run, % "control.exe /name Microsoft.NetworkandSharingCenter"
}
else if(MasterScriptCommands = "filepath to html path"){ ;~ Convert file path to HTML path
	; gui_destroy()
	Clipboard := RegExReplace(Clipboard,"\\","/")
	Notify().AddWindow(Clipboard, {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
}
else if(MasterScriptCommands = "filepath to js esc \\"){ ;~ Convert file path to js esc with double \\
	; gui_destroy()
	Clipboard := RegExReplace(Clipboard,"\\","\\")
	Notify().AddWindow(Clipboard, {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
}
else if(MasterScriptCommands = "ep drop"){ ;~ Open NW Dropbox
	; gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
...
else if(MasterScriptCommands = "ep cpa"){ ;~ Open NW Dropbox CPA
	; gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	if FileExist(EnvVars("%LOCALAPPDATA%\Dropbox\info.json"))
		FileRead, strDropboxJsonFileContent, % EnvVars("%LOCALAPPDATA%\Dropbox\info.json")
...
else if(MasterScriptCommands = "spaces to underscores"){ ;~ Spaces to Underscores
	; gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	Clipboard := RegExReplace(Clipboard, "\s", "_")
}
else if(MasterScriptCommands = "ep 2mx to folder"){ ;~ 2mx to Netflix folder COPY
	; gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
...
else if(MasterScriptCommands = "ep netflix renaming"){ ;~ Rename files according to Netflix Rules
	; gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	; Fix naming scheme
	; parse by _
...
else if(MasterScriptCommands = "ep hub"){ ;~ NW Script Hub
	; gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	Run % "D:\Users\Dillon\Dropbox\AHK Scripts\_DMD Scripts\NW Work Scripts\NW Scripts Hub\NW Scripts Hub.ahk"
}
else if(MasterScriptCommands = "reset midi"){ ;~ Reset MidiOX
	; gui_destroy()
...
else if(MasterScriptCommands = "install qap"){ ;~ Install New QAP Port Version
	; gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	Run % A_Dropbox "\AHK Scripts\_DMD Scripts\QAP\QAP Install New Portable Version.ahk"
}
else if(MasterScriptCommands = "sum of times"){ ;~ Sum of Times from Clipboard
	; gui_destroy()
	vDuration := 0
	Loop, Parse, Clipboard, "`n`r" 
	{
...
else if(MasterScriptCommands = "difference of times" || MasterScriptCommands = "diff of times"){ ;~ Difference of Times
	; gui_destroy()
	vDuration := 0
	oDuration := []
	Loop, Parse, Clipboard, "`n`r" 
	...
	*/
...
else if(MasterScriptCommands = "crom"){ ;~ Load Remote Server Chrome
	; gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:AHK Scripts_Master ScriptResourcesMaster If Commands IconsCogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	Run, % A_MyDocuments "\CROM.rdp"
}
else if(MasterScriptCommands = "server"){ ;~ Load Remote Server DMD
	; gui_destroy()
...
else if(MasterScriptCommands = "% diff"){ ;~ Percentage Difference Calculator
	; gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	JS =
	(LTrim Join`n
	...
	Swal.Toast(Clipboard,{timer:1500})
}
else if(MasterScriptCommands = "ps5"){ ;~ Search for PS5
	; gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	oObj := ["https://www.bestbuy.com/site/searchpage.jsp?st=ps5&_dyncharset=UTF-8&_dynSessConf=&id=pcat17071&type=page&sc=Global&cp=1&nrp=&sp=&qp=&list=n&af=true&iht=y&usc=All+Categories&ks=960&keys=keys"
		   ,"https://www.samsclub.com/s/ps5?altQuery=1206&rootDimension=category%3A1206pipsymbProduct%20Type%3AVideo%20Game%20Consoles"
		   ,"https://www.walmart.com/search?q=ps5+console"]
	for a, b in oObj {
		Run % b
	}
}
else if(MasterScriptCommands = "neutron debug"){ ;~ IeChooser
	; gui_destroy()
	Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:\AHK Scripts\_Master Script\Resources\Master If Commands Icons\Cogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
	Run % A_ComSpec "\..\F12\IEChooser.exe"
}
else if(MasterScriptCommands = "toast"){ ;~ testing toast
	; gui_destroy()
	Swal.toast("hi")
}
else if(MasterScriptCommands = "%%%%%"){ ;~ Type Command Title Here
    gui_destroy()
    Notify().AddWindow(MSC_Title(MasterScriptCommands, DIR), {Title:"Master Script Commands", Font:"Sans Serif", TitleFont:"Sans Serif", Icon:"C:AHK Scripts_Master ScriptResourcesMaster If Commands IconsCogwheel Settings.ico, 1", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0xFFFFFF", Color:"0x282A2E", TitleColor:"0xFF0000"})
