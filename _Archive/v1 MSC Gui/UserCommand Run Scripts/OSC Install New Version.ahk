...
OSC_Zip    := Clipboard
OSC_Folder := A_ProgramFiles "\Open Stage Control"							;~ Location of OSC Folder 
...
Notify().AddWindow("has been Installed", {Title:vName, Font:"Sans Serif", TitleFont:"Sans Serif", Icon: OSC_Folder "\open-stage-control.exe", Animate:"Right, Slide", ShowDelay:100, IconSize:64, TitleSize:14, Size:20, Radius:26, Time:2500, Background:"0x2C323A", Color:"0xD8DFE9", TitleColor:"0xD8DFE9"})
