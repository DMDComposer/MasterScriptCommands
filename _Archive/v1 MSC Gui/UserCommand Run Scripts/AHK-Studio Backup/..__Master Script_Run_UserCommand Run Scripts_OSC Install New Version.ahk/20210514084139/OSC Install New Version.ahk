...
Notify().AddWindow("has been Installed" ;~ Remove "" if want to use a variable, NO percents!
	...
	,Icon:"C:\Program Files (x86)\Open Stage Control\open-stage-control.exe" ;~  Can be either an Integer to pull an icon from Shell32.dll or a full path to an EXE or full path to a dll.  You can add a comma and an integer to select an icon from within that file eg. {Icon:"C:\Windows\HelpPane.exe,2"}
