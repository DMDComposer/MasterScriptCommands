...
#Include <Chrome.ahk> ;GeekDude Class ; https://github.com/G33kDude/Chrome.ahk https://autohotkey.com/boards/viewtopic.php?t=42890
...
oArr := [40, 41, 42, 50, 77, 79]
Random, Random_Selection, 1, oArr.length() ;~ Random selection for which songs I want to put on the playlist

;~ Select Song I want using index number
Page.Evaluate("document.querySelector('#wheelSongId').focus()")
Page.Evaluate("document.querySelector('#wheelSongId').selectedIndex = '" oArr[Random_Selection] "'") ;~ Must have space between '" xxx "'
