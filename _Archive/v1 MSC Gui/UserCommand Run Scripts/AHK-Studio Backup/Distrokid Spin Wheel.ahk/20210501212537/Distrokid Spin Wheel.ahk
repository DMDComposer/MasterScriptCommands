...
Return
;~ ^+\::
;~ Page.Evaluate("document.querySelector(""#main_input"").value = '" CMT "'")
Page.Evaluate("document.querySelector(""#main_input"").focus()")
...
var := Page.Evaluate("document.querySelector(""#main_input"").value").value ;~ Converted text with correct
;~ m(var)
WinActivate, % Title
Sleep, 50
Send, % var
