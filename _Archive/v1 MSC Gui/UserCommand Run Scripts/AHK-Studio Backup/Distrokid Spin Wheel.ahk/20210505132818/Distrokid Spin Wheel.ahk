...
tloop := Page.Evaluate("document.querySelector('body > div:nth-child(16) > div > div:nth-child(4) > div > div.gameTime > div:nth-child(1) > div.outer2.wheelErrorContainer > div > div:nth-child(2) > a')?.innerText").value = "Go listen to the playlist"
