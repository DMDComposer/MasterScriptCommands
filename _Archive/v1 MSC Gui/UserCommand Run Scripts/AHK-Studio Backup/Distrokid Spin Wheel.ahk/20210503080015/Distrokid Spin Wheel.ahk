...
Loop {
	Sleep, 10
}Until Page.Evaluate("document.querySelector('.buttonSpotify').innerText = 'Connect with Spotify'")
...
Loop {
	Sleep, 10
}Until Page.Evaluate("document.querySelector('.buttonPink').innerText = 'Spin Wheel'")
...
Loop {
	Sleep, 10
}Until Page.Evaluate("document.querySelector('.buttonPink').innerText = 'Spin Again!'")
Page.Evaluate("document.querySelector('.buttonPink').click()")

Loop {
	Sleep, 10
}Until Page.Evaluate("document.querySelector('.buttonPink').innerText = 'Spin once more!'")
Page.Evaluate("document.querySelector('.buttonPink').click()")
