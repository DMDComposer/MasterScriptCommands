...
/*
	else if(MasterScriptCommands = "kill "){ ;~ Kill Process
		gui_destroy()
		Process, Close, 
	}
...
*/
	...
	*/
	...
	Notify().AddWindow("Running Adobe Photoshop",{Animate:"Center",ShowDelay:100,Icon:300,IconSize:50,Title:"",TitleSize:14,Size:12,Time:6000,Background:0x0000FF})
	Photoshop:= "Adobe Creative Cloud ahk_exe Adobe Desktop Service.exe"
	WinWaitActive, %Photoshop%
	If WinExist(Photoshop) {
		Notify().AddWindow("We found the window",{Animate:"Center",ShowDelay:100,Icon:300,IconSize:50,Title:"",TitleSize:14,Size:12,Time:6000,Background:0x0000FF})
	}
	WinClose, %Photoshop%
}
	...
	Notify().AddWindow("Running Adobe Premiere",{Animate:"Center",ShowDelay:100,Icon:300,IconSize:50,Title:"",TitleSize:14,Size:12,Time:6000,Background:0x0000FF})
}
...
else if(MasterScriptCommands = "vepro"){ ;~ Run VEPRO 7
	gui_destroy()
	Run, "C:\Program Files\Vienna Ensemble Pro\Vienna Ensemble Pro.exe" -server
	Notify().AddWindow("Running VEPRO 7",{Animate:"Center",ShowDelay:100,Icon:300,IconSize:50,Title:"",TitleSize:14,Size:12,Time:6000,Background:0x0000FF})
}
...
else if(MasterScriptCommands = "shell icons"){ ;~ Name of Command
	gui_destroy()
