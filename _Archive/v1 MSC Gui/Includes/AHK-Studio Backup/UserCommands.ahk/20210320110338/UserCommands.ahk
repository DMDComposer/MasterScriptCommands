...
else if(MasterScriptCommands = "photoshop"){ ;~ Name of Command
	gui_destroy()
...
else if(MasterScriptCommands = "disable internet"){ ;~ Name of Command
	gui_destroy()
	Run, netsh interface set interface name="Local Area Connection" admin=DISABLED
}
else if(MasterScriptCommands = "enable internet"){ ;~ Name of Command
	gui_destroy()
	Run, netsh interface set interface name="Local Area Connection" admin=ENABLE
}
