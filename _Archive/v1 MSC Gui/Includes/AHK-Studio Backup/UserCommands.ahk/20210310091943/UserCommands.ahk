...
else if(MasterScriptCommands = "notify options"){ ;~ List of Notify Options
	gui_destroy()
	x = Usage:`rNotify:=Notify()`rWindow:=Notify.AddWindow("Your Text Here",{Icon:4,Background:"0xAA00AA"})`r|---Window ID`r|--------Options`rOptions:`r	
