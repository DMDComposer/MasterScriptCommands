...
if (MasterScriptCommands = "ahk "){ ;~ Search for AHK Related Info
	...
	gui_search_title:= "Search for Udemy/Skillshare Courses"
	...
	gui_search_title:= "Type in the Name of the Class"
	gui_Change_Title("Math Time!",cRed)
	gui_search(Eval("REPLACEME"))
}

else if(MasterScriptCommands = "eval("MasterScriptCommands")"){ ;~ Name of Command
	gui_destroy()
	msgbox, % Eval(MasterScriptCommands)
}
...
;~ /////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	Run, *RunAs "C:\Program Files\AutoHotkey\AutoHotkeyU64_UIA.exe" /restart "C:\AHK Studio\AHK-Studio.ahk"
}
else if(MasterScriptCommands = "n. color"){ ;~ Notion Color Selector GUI
	gui_destroy()
