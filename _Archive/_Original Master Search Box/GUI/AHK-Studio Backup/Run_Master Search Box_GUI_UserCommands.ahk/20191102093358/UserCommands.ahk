...
;;; SEARCH GOOGLE ;;;
;-------------------------------------------------------------------------------
if (MasterScriptCommands = g Chr(32) || MasterScriptCommands = g Chr(33)){ ; Search Google
...
else if MasterScriptCommands = drop.%A_Space% ; Dropbox folder (works when it is in the default directory)
{
    gui_destroy()
    run, C:\Users\%A_Username%\Dropbox\
}
else if MasterScriptCommands = recycle.%A_Space% ; Recycle Bin
{
    gui_destroy()
