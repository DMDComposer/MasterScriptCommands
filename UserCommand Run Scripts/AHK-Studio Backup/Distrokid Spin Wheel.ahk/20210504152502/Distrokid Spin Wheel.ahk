...
If Page.Evaluate("document.querySelector('.buttonPink').innerText").value = "Spin Again!"
	m("It does")
else
	m("it does not")
m(Page.Evaluate("document.getElementsByClassName('buttonPink spinWheelButton').innerText"))
