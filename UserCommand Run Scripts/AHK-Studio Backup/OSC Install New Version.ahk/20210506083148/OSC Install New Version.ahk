...
topfldr := "C:\Users\XXX\Folder_A\Folder_B"
Loop, Files, % OSC_Unzip "\*.*", RF
	DebugWindow(A_LoopFileFullPath,Clear:=0,LineBreak:=1,Sleep:=250,AutoHide:=0)
	;~ FileMove, %A_LoopFileFullPath%, %OSC_Unzip%, 1
