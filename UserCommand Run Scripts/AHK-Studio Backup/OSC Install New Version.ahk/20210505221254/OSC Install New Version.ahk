...
RunWait, "C:\Program Files\7-Zip\7z.exe" x "%OSC_Zip_New%" -o"%OSC_Folder%"\ -y, % 7zip,Hide, ZipPID
while(WinExist(ahk_pid ZipPID)){
	DebugWindow("stil here",Clear:=0,LineBreak:=1,Sleep:=250,AutoHide:=0)
}
Return