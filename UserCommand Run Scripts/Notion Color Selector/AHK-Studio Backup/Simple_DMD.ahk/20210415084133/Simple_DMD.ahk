...
#Include ../../Neutron.ahk
#Include "C:\AHK Studio\Lib\Notify.ahk"
...
Example1_Button(neutron, event)
{
	...
	Notify().AddWindow("You clicked: " event.target.innerText ;~ Remove "" if want to use a variable, NO percents!
	,{Title:"Notion Color Selector" 
	,Font:"Sans Serif"
